    ...
    return (
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          headerTitle: () => (
            <Image source={Logo} style={{ width: 240, height: 45 }} />
          ),
        })}
      >
        <Tab.Screen
          ...
          options={{ tabBarLabel: i18n.t("publishTask") }}
        />
        <Tab.Screen
          ...
          options={{
            headerTitle: () => (
              <AirCarerText variant="bold">
                {i18n.t("browsingTasks")}
              </AirCarerText>
            ),
        ...
        <Tab.Screen
          ...
          options={{
            headerTitle: () => (
              <AirCarerText variant="bold">{i18n.t("myTasks")}</AirCarerText>
            ),
        ...
        <Tab.Screen
          ...
          options={{
            headerTitle: () => (
              <AirCarerText variant="bold">{i18n.t("account")}</AirCarerText>
            ),
    ...
    return (
      ...
      >
        ...
        <Stack.Screen
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("editProfile.skillsSettingsTitle"),
          }}
        />
        <Stack.Screen
          name="Transportation"
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("editProfile.transportation"),
          }}
        />
        <Stack.Screen
          name="Languages"
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("editProfile.languages"),
          }}
        />
        <Stack.Screen
          name="Education"
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("editProfile.education"),
          }}
        />
        <Stack.Screen
          name="Work"
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("editProfile.work"),
          }}
        />
        <Stack.Screen
          name="Specialties"
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("editProfile.specialties"),
          }}
        />
        <Stack.Screen
          ...
          options={{
            headerShown: true,
            headerTitle: i18n.t("accountTab.settings"),
          }}
        />
        <Stack.Screen
        ...
        />
        <Stack.Screen
          name="browsing-task/task-conclusion/provider"
          component={TaskConclusionScreen}
          options={{
            headerShown: true,
            headerTitle: "Task Conclusion",
          }}
        />
        <Stack.Screen
          name="browsing-task/task-conclusion/customer"
          component={TaskConclusionScreen}
          options={{
            headerShown: true,
            headerTitle: "Task Conclusion",
